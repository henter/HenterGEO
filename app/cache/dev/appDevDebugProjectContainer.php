...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/henter/Work/hentergeo/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Users/henter/Work/hentergeo/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'mongo_test', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager518e9304606f2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager518e9304606f2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/Users/henter/Work/hentergeo/app/cache/dev/jms_diextra/doctrine/EntityManager_518e9304606f2.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_90851781fc7026e12feae9a3596171cd');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_90851781fc7026e12feae9a3596171cd');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_90851781fc7026e12feae9a3596171cd');
        ...
        $d->setProxyDir('/Users/henter/Work/hentergeo/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager518e9304606f2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2mongodb_default_90851781fc7026e12feae9a3596171cd');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver(new \Doctrine\ODM\MongoDB\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Users/henter/Work/hentergeo/src/Henter/GEOBundle/Document')), 'Henter\\GEOBundle\\Document');
        ...
        $instance->setDocumentNamespaces(array('HenterGEOBundle' => 'Henter\\GEOBundle\\Document'));
        $instance->setMetadataCacheImpl($a);
        $instance->setMetadataDriverImpl($b);
        $instance->setProxyDir('/Users/henter/Work/hentergeo/app/cache/dev/doctrine/odm/mongodb/Proxies');
        $instance->setProxyNamespace('MongoDBODMProxies');
        $instance->setAutoGenerateProxyClasses(false);
        $instance->setHydratorDir('/Users/henter/Work/hentergeo/app/cache/dev/doctrine/odm/mongodb/Hydrators');
        $instance->setHydratorNamespace('Hydrators');
        $instance->setAutoGenerateHydratorClasses(false);
        $instance->setDefaultDB('mongo_test');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Users/henter/Work/hentergeo/app/Resources');
    }
    ...
    /**
     * Gets the 'geo.twig.geo_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Henter\GEOBundle\Twig\GEOExtension A Henter\GEOBundle\Twig\GEOExtension instance.
     */
    protected function getGeo_Twig_GeoExtensionService()
    {
        return $this->services['geo.twig.geo_extension'] = new \Henter\GEOBundle\Twig\GEOExtension($this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/Users/henter/Work/hentergeo/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Users/henter/Work/hentergeo/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Users/henter/Work/hentergeo/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Users/henter/Work/hentergeo/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Users/henter/Work/hentergeo/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/henter/Work/hentergeo/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Users/henter/Work/hentergeo/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/Users/henter/Work/hentergeo/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/Users/henter/Work/hentergeo/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension($this->get('geo.twig.geo_extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Users/henter/Work/hentergeo/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
     ...
     *
     * @return EntityManager518e9304606f2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/henter/Work/hentergeo/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Users/henter/Work/hentergeo/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/Users/henter/Work/hentergeo/app/cache/dev/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/Users/henter/Work/hentergeo/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/henter/Work/hentergeo/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/Users/henter/Work/hentergeo/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/henter/Work/hentergeo/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/henter/Work/hentergeo/app/cache/dev',
            'kernel.logs_dir' => '/Users/henter/Work/hentergeo/app/logs',
            'kernel.bundles' => array(
                ...
                'HenterGEOBundle' => 'Henter\\GEOBundle\\HenterGEOBundle',
            ...
            'debug.container.dump' => '/Users/henter/Work/hentergeo/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Users/henter/Work/hentergeo/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/Users/henter/Work/hentergeo/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/Users/henter/Work/hentergeo/app/cache/dev/profiler',
            ...
            'router.resource' => '/Users/henter/Work/hentergeo/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/henter/Work/hentergeo/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => '/Users/henter/Work/hentergeo/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/Users/henter/Work/hentergeo/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Users/henter/Work/hentergeo/app/../web',
            'assetic.write_to' => '/Users/henter/Work/hentergeo/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Users/henter/Work/hentergeo/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/Users/henter/Work/hentergeo/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/Users/henter/Work/hentergeo/app/cache/dev/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/Users/henter/Work/hentergeo/app/cache/dev/jms_diextra/doctrine/EntityManager_518e9304606f2.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager518e9304606f2_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/Users/henter/Work/hentergeo/app/cache/dev/jms_security',
            ...
            'doctrine_mongodb.odm.proxy_dir' => '/Users/henter/Work/hentergeo/app/cache/dev/doctrine/odm/mongodb/Proxies',
            'doctrine_mongodb.odm.auto_generate_proxy_classes' => false,
            'doctrine_mongodb.odm.hydrator_namespace' => 'Hydrators',
            'doctrine_mongodb.odm.hydrator_dir' => '/Users/henter/Work/hentergeo/app/cache/dev/doctrine/odm/mongodb/Hydrators',
